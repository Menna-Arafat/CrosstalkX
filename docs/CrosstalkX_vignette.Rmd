---
title: "CrosstalkX: Mutual Information–Based Inference of Pathway Crosstalk"
author: "Menna Arafat"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{CrosstalkX_vignette}
...
## Overview:
 The tutorial proceeds in three stages. First, it prepares expression and DE-derived inputs.
 Second, it prioritizes genes by testing whether their network neighborhoods are enriched
 for DE genes more than expected by chance. Third, it performs enrichment on prioritized
 genes, then infers significant term–term crosstalk and visualizes the result.
